return {
	{
		...
		config = function()
			...
			normal_mappings.g.y = { "<Plug>(coc-type-definition)", "[Coc] Type definition", mode = "n", silent = true }
			normal_mappings.g.i = { "<Plug>(coc-implementation)", "[Coc] implementation", mode = "n", silent = true }
			...
			-- Symbol renaming
			normal_mappings["<leader>rn"] = { "<Plug>(coc-rename)", "[Coc] Rename symbol", mode = "n", silent = true }
			...
			opts_mappings["<leader>ac"] = { "<Plug>(coc-codeaction-cursor)", "[Coc] Code action cursor", mode = "n" }
			-- Remap keys for apply source code actions for current file.
			opts_mappings["<leader>as"] = { "<Plug>(coc-codeaction-source)", "[Coc] Code action source", mode = "n" }
			...
			normal_mappings["<C-s>"] = { "<Plug>(coc-range-select)", "[Coc] Range select", mode = "n", silent = true }
			normal_mappings["<C-s>"] = { "<Plug>(coc-range-select)", "[Coc] Range select", mode = "x", silent = true }
			...
			opts_mappings["<space>a"] = { ":<C-u>CocList diagnostics<cr>", "[Coc] List diagnostics", mode = "n" }
			-- Manage extensions
